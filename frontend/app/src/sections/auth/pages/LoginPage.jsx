    ...
    <div className="login-container">
      <div className="login-card">
        <div className="login-content">
          <div className={success ? "success login-header" : loginError ? "login-header fail" : "login-header"}> 
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="login-form">
            ...
            {errors.identifier && <p className="error-message">This field is required</p>}
            ...
            <div className="form-options">
              <div className="remember-me">
                <input id="remember" type="checkbox" {...register("isRememberMe", { required: false })} />
            ...
            {loginError && <p className="error-message" style={{ textAlign: 'center' }}>{loginError}</p>}
          </form>
